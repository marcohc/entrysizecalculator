...
// //
// //   Binance(this._apiKey, this._secret);
// //
//   _response(request) async {
//     try {
//       var response;
//       String timestamp = "timestamp=" + new DateTime.now().millisecondsSinceEpoch.toString();
//       String query = request['query'] + '&' + timestamp;
//       String signature = _hmacSha256(query, this._secret);
//       final url = 'https://api.binance.com' +
//           request['endPoint'] +
//           "?" +
//           query +
//           '&signature=' +
...
//         response = await get(Uri.parse(url), headers: {'X-MBX-APIKEY': this._apiKey});
//       } else {
//         response = await post(Uri.parse(url), headers: {'X-MBX-APIKEY': this._apiKey});
//       }
//       return response;
//     } on Exception {
//       return null;
